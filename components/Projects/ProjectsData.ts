...
export const projects = [
  {
    title: "CrowdFund App",
    subtitle: "Solidity | NextJS | Web3Js | Ethereum",
    description:
  ...
  {
    title: "P2P Electricity Transfer Application",
    subtitle: " NextJS/ReactJS | Solidity | Polygon",
    description:
  ...
  //     subtitle: "Solidity",
  //     description:
  //       "Solidity notes for clear understanding of the language with brief example",
  //     image: Background,
  ...
  //     subtitle: "Vuforia| Unity3D| C# ",
  //     description:
  //       "Built an application for android. Used anchors to place objects at a fixed location relative to the real world.",
  //     image: Background,
  //     link: "https://github.com/quaintrelle7/Greeting-Card",
  //   },
];
